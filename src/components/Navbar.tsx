        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <Link to="/clothing" className="text-muted-foreground hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors">Clothing</Link>
              <Link to="/toys" className="text-muted-foreground hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors">Toys</Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-background border-b border-border/10">
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <Link to="/clothing" className="text-muted-foreground hover:text-primary block px-3 py-2 rounded-md text-base font-medium">Clothing</Link>
            <Link to="/toys" className="text-muted-foreground hover:text-primary block px-3 py-2 rounded-md text-base font-medium">Toys</Link>
