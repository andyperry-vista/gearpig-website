  ...
  theme: {
    container: {
      ...
      fontFamily: {
        ...
        sub: ["'Beelzebrush BB'", "cursive", "sans-serif"],
      ...
      keyframes: {
        ...
        "neon-edge-glow": {
          "0%, 100%": {
            filter: "drop-shadow(0 0 3px hsl(191 100% 50% / 0.15)) drop-shadow(0 0 6px hsl(334 100% 50% / 0.08))",
          },
          "50%": {
            filter: "drop-shadow(0 0 5px hsl(334 100% 50% / 0.2)) drop-shadow(0 0 8px hsl(191 100% 50% / 0.1))",
          },
        },
      },
      animation: {
